...
class Login extends PoCore
{
	...
	<form role="form" action="<?= WEB_URL . DIR_ADM; ?>/route.php?mod=login&act=proclogin" method="post" id="form-login" autocomplete="off">
		<div class="form-group">
			...
			<input type="text" name="username" id="login-username" class="form-control" placeholder="Masukan Username">
		</div>
	...
	<a style="color:#6d6d6d" href="index.php?mod=login&act=forgot" class="forget" title="Forgot your password?">Lupa password?</a>
	<hr>
<?php
}
...
public function forgot()
{
	...
	<a href="index.php" class="forget" title="Back to login">Back to login</a>
	<hr>
<?php
}
