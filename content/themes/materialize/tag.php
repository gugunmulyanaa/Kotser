    ...
    <div class="container">
        <div class="row section-gap-half">
            <div class="col-lg-12 text-center">
                ...
                <h4 style="color:#fff;"><?= $this->e($front_tag); ?></h4>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="blog-lists">
                    <?php
                    $tags = $this->post()->getPostFromTag('5', 'post.id_post DESC', $this->e($tag_seo), $this->e($page), WEB_LANG_ID);
                    ...
                    <nav>
                        <ul class="pagination">
                            <?= $this->post()->getTagPaging('5', $this->e($tag_seo), $this->e($page), '1', $this->e($front_paging_prev), $this->e($front_paging_next)); ?>
                        </ul>
                    </nav>
                </div>
            </div>
