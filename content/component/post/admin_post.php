...
class Post extends PoCore
{
	...
	public function datatable()
	{
		...
		$columns = array(
			array(
				'db' => 'p.' . $primarykey, 'dt' => '0', 'field' => $primarykey,
			...
			array(
				'db' => 'p.' . $primarykey, 'dt' => '2', 'field' => $primarykey,
				'formatter' => function ($d, $row, $i) {
			...
			array(
				...
				'formatter' => function ($d, $row, $i) {
					...
					return "" . $d . "<br /><i><a href='" . $this->postring->permalink(rtrim(WEB_URL, '/'), array('id_post' => $row['id_post'], 'seotitle' => $row['seotitle'], 'date' => $row['date'])) . "' target='_blank'>" . $this->postring->permalink(rtrim(WEB_URL, '/'), array('id_post' => $row['id_post'], 'seotitle' => $row['seotitle'], 'date' => $row['date'])) . "</a></i><br />
