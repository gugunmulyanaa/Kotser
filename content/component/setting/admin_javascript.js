...
$(document).ready(function () {
	...
	function getJsonCountry() {
		var arr = [];
		$.getJSON("../includes/core/json/country.json", function (data) {
	...
	function getJsonRegion(country) {
		...
		$.getJSON("../includes/core/json/region/" + country + ".json", function (data) {
	...
	function getJsonTimezone() {
		var arr = [];
		$.getJSON("../includes/core/json/timezone.json", function (data) {
			$.each(data, function (key, val) {
				arr.push({
					value: val.value,
					text: val.text
	...
	$('#permalink').editable({
		source: [{
				value: 'slug/post-title',
				text: 'slug/post-title'
			},
			{
				value: 'yyyy/mm/dd/post-title',
				text: 'yyyy/mm/dd/post-title'
			},
			{
				value: 'yyyy/mm/post-title',
				text: 'yyyy/mm/post-title'
			},
			{
				value: 'archives/post-id',
				text: 'archives/post-id'
			},
			{
				value: 'slug-post-id-post-title',
				text: 'slug-post-id-post-title'
			},
			{
				value: 'post-title',
				text: 'post-title'
