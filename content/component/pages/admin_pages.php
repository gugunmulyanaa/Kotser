...
class Pages extends PoCore
{
	...
	public function datatable()
	{
		...
		$columns = array(
			...
			array(
				'db' => 'p.' . $primarykey, 'dt' => '4', 'field' => $primarykey,
				'formatter' => function ($d, $row, $i) {
					return "<div class='text-center'>\n
							...
							<div class="form-group" id="image-box">
								<div class="row">
									...
									<?php } else { ?>
										...
										<div class="col-md-10">
											<a href="../content/uploads/<?= $current_pages['picture']; ?>" target="_blank"><?= $GLOBALS['_']['pages_picture_6']; ?></a>
											<p>
