	...
	public function index()
	{
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="widget">
					<div class="mini-stats">
						<a href="admin.php?mod=gallery"><span class="bg-success"><i class="fa fa-picture-o"></i></span></a>
						<p>Gallery</p>
						<h3><?= $this->podb->from('gallery')->count(); ?></h3>
					</div>
				</div>
			</div>
			<div class="col-md-3">
			...
			<div class="col-md-3">
				<div class="widget">
					<div class="mini-stats">
						<a href="admin.php?mod=user"><span class="bg-danger"><i class="fa fa-group"></i></span></a>
						<p>Users</p>
	...
	public function error()
	{
		...
		<div class="row">
			<div class="col-lg-12 text-center">
				<h1 class="page-header">Halaman Tidak Ditemukan <small class="text-danger">Error 404!</small></h1>
				<p>
					Halaman yang anda minta tidak ditemukan, Jika terjadi kesalahan atau Error
					Hubungi DISKOMINFO KOTA SERANG.<br />
					Silahkan refresh kembali halaman ini atau <b>klik tombol dibawah ini </b>
				</p>
