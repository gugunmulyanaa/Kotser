		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="box info">
					<h2>Info</h2>
					<section>
						<p>Geser list menu untuk mengatur posisi, kemudian click <b>Update Menu</b> untuk menyimpan posisi menu.</p>
						<p>Untuk Tambah Menu, Gunakan <b>Add Menu</b> pada form dibawah ini.</p>
					</section>
				</div>
				<div class="box">
